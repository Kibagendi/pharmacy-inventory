...
<TR><TD  colspan="6"> List of Product Category</TD></TR> 
...
<TR>
  ...
  <TD> Delete Category </TD>
    ...
    for ( int i = 0; i < catalog.size(); i++ ) {
        ...
        <TD><a href="../jsp/editProductCategory.jsp?productCategoryIndex=<%= i %>">Edit Category</a></TD>
        <TD><a href="../jsp/listProductCategory.jsp?op=delete&index=<%= i %>">X</a></TD>        
        </TR>
        <%
    }
%>
...
<p>Number of categories <% out.println(catalog.size()); %><p>
<p><a href="../html/newProductCategory.html">New Product Category</a><p>
